...
### 12. Test und Auswertung DHD-Verfahren

#Loeschen der ersten Spalte, die automatisch hinzugefügt wird
donor <- donor[, -1]
recipient <- recipient[, -1]

# 12.1 Erstellung Variablen, Funktionen und Kontigenztabellen für Verteilungsauswertung

# 12.1.1 Erstellung Pearson's C Funktion
...
# 12.1.2 leere Vektoren fÃ¼r for Schleife
...
# 12.2 Training und Test des Modells
...
for (w in 1:1) {
  ...
  #write.csv2(recipient, paste(daten,"/ergebnisse/12_fusionsdatensatz_DHD.csv", sep = ""))
  
  # 12.4 Auswertung Genauigkeit (Ebene 1)
  ...
  #12.5 Erstellung Variablen für die Verteilungsauswertung
  ...
  # 12.5.1 Erstellung der decoded-Variablen zur Auswertung der bedingten Verteilungen
  ...
  # 12.5.2 Erstellung Kontigenztabellen für Ebene 4
  ...
  # 12.5.3 gesamter originaler Datensatz
  orig_recipient <- select(recipient, -AccidentType_pred)
  d.gesamt.data = rbind(orig_recipient, donor)
  
  # 12.6 Auswertung der gemeinsamen Verteilung (Ebene 2)
  
  # 12.6.1 Vergleich der Gesamtverteilung von fXZ, Vorhergesagte Variable im recipient vs. tatsächliche Variable im recipient
  ...
  # 12.6.2 Vergleich der Gesamtverteilung von fXZ, Vorhergesagte Variable im recipient vs. tatsächliche Variable im Gesamtdatensatz
  ...
  # 12.6.3 Vergleich der Verteilung von fz
  ...
  # 12.6.4 Vergleich der tatsächlichen Gesamtverteilungen von donor und recipient als Maßstab der Ungebnauigkeit des Datensplits bzw. Randomness der HD
  ...
  # 12.7 Auswertung der Randverteilung (Ebene 4)
  
  # 12.7.1 Vergleich der Gesamtverteilung von fXZ vom fusionierten Datensatz mit dem Spenderdatensatz --> real testbar
  ...
  #12.7.2 Vergleich der Randverteilung von Z (AccidentType) --> imputierte Variable
  ...
  # 12.7.3 Vergleich der Verteilung von fXZ --> jeweils fÃ¼r jede XZ Kombination 
  ...
  # 12.8 Speichern der multiplen Durchläufe als Ergebnis in Vektoren und Ausgabe
  
  # 12.8.1 Erhalt der einzelnen Werte 
  
  vec.accuracy <- c(vec.accuracy,accuracy)
  
  # 12.8.2 Erhalt der gemeinsamen Verteilung
  ...
  # 12.8.3 Erhalt der Randverteilung
...
# 12.9 Zusammenfassung in Dataframes
...
#saveRDS(df.Ebene1, paste(daten,"/Ergebnisse/12_df_Ebene1_dhd.rds", sep = ""))
#saveRDS(df.Ebene2, paste(daten,"/Ergebnisse/12_df_Ebene2_dhd.rds", sep = ""))
#saveRDS(df.Ebene4, paste(daten,"/Ergebnisse/12_df_Ebene4_dhd.rds", sep = ""))
